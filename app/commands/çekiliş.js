...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    if (args[0] == "yap") {
      ...
      if (!args[1]) {
        ...
        const yanlış = new Discord.MessageEmbed()
          ...
          .setColor("#3f007f")
          .setDescription(
            ":x: **| Çekiliş Ne Kadar Sürecek? (`x saniye`, `x dakika`, `x saat`, `x gün` Şeklinde Yazınız)**"
          )
      ...
      if (!args[3]) {
        ...
        const yanlış = new Discord.MessageEmbed()
          ...
          .setColor("#3f007f")
          .setDescription(":x: **| Çekilişte Kaç Kazanan Olacak?**")
          .setFooter("🔮 Tüm Hakları Saklıdır.");
        return message.channel
          .send(yanlış)
          .then(msg => msg.delete({ timeout: 10000 }));
      ...
      if (!args.slice(4).join(" ")) {
        ...
        const yanlış = new Discord.MessageEmbed()
          ...
          .setColor("#3f007f")
          .setDescription(":x: **| Çekilişte Ne Verilecek?**")
          .setFooter("🔮 Tüm Hakları Saklıdır.");
        return message.channel
          .send(yanlış)
          .then(msg => msg.delete({ timeout: 10000 }));
      ...
      let embed = new Discord.MessageEmbed()
        ...
        .setFooter(
          `${kazanacak} Kazanan Olacak | ID: ${cekilisid} | Kylee Tarafından Sağlanmıştır  | Kalan Süre:`
        )
            ...
            if (kalanzaman <= 0) {
              ...
              if (asilkisisayisi < kazanacak) {
                let embed = new Discord.MessageEmbed()
                  ...
                  .setFooter(
                    `${kazanacak} Kazanan Olacak | ID: ${cekilisid} | Kylee Tarafından Sağlanmıştır | Bitti:`
                  )
                  .setTimestamp(bitecegizamanms)
                  .setColor("#3f007f");
                msg.edit(embed);
    ...
    const yanlış = new Discord.MessageEmbed()
      ...
      .setColor("#3f007f")
      .setDescription(":x: **| Yanlış Kullanım: ?çekiliş yap**")
      .setFooter("🔮 Tüm Hakları Saklıdır.");
