...
exports.run = async (client, message, args) => {
    ...
    async function handleVideo(video, message, voiceChannel, playlist = false) {
        ...
        .setColor("#0f0f0f")
        .setAuthor(`Şuan oynayan`, song.thumbnail)
        .setDescription(`[${song.title}](${song.url})`)
        .addField("Video süresi<a:mabise:714498465429848105>", `${y}`, true)
        .addField("Videoyu açan<a:mabise:714498465429848105>", `${song.requester}`, true)
